    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                <th>项目介绍</th>
                <td>
                    <textarea name="description" rows="3" cols="50">{$info.description??''}</textarea>
                </td>
            </tr>
            <tr>
                <th>封面图片</th>
            ...
            <tr>
                <th>添加时间</th>
                <td>
                    <input class="form-control text" type="text" name="sendtime" value="{$info.sendtime??''}" placeholder="yyyy-MM-dd" id="sendtime">
                </td>
            </tr>
            <tr>
